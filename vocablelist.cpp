...
VocableList::VocableList(QObject *parent) :
    QObject(parent)
{
}

QSidze VocableList::sizeHint(const QStyleOptionViewItem &  option ,
                         d
void VocableList::paint(QPainter *painter, const QStyleOptionViewItem &option,
